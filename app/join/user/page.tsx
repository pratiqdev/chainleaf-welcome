...
const Join = () => {
    ...
    return (
        <div className="bg-slate-100 dark:bg-slate-900 p-4 md:p-8 text-black dark:text-white min-w-[24rem] rounded-lg mx-auto mt-4 w-min shadow-lg flex flex-col items-center">
            <h2 className="text-2xl text-primary-5 dark:text-primary font-bold m-6 text-center">Welcome to Chainleaf!</h2>
            <Balancer className="text-md leading-6 m-4 text-center">
                Create a <b>User</b> account to browse and purchase authentic products, or&nbsp;
            ...
            <RegisterForm type="Consumer" callback="/join/user/getting-started"/>
        </div>
    )
}
