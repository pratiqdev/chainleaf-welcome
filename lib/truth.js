...
const social = {
    at: '@chainleaflabs',
    name: 'Chainleaf Labs',
    title: "Welcome | Chainleaf Labs",
    url: 'https://chainleaflabs.com',
...
const truth = {
    ...
    metadata: {
        title: social.name,
        title: {
            default: 'Chainleaf Labs',
            template: '%s | Chainleaf Labs',
        },
    ...
    hero: {
        ...
        heading: `Trust the brands you use`,
        subheading: `and get what you paid for`,
        subtext: 'Blockchain platform revolutionizing agricultural supply chain transparency',
        link: {
            text: `Get Started`,
        ...
        sections: [
            {
                ...
                links: [
                    ...
                    // {
                        ...
                        {
                            text: `Join the Beta`,
                            href: links.action.whySubscribe,
                        },
                    {
                        text: `Learn More`,
                        href: links.docs.home,
                ...
                },
                {
                    ...
                    links: [
                        {
                            text: `Contact Us`,
                            href: 'mailto:support@chainleaflabs-group.com',
                        },
                    {
                        text: `LinkedIn`,
                        href: `https://www.linkedin.com/company/chainleaflabs`,
                    },
                    {
                        text: `Leave Feedback`,
                        href: '/join/feedback',
            ...
            subsections: [
                {
                    ...
                    content: `Share verifiable product and certificate data through our platform`,
                    icon: Icons.lg.ShieldCheckIcon
                },
                {
                    heading: `Prove your Value`,
                    content: `Allow consumers to prove your value with our immutable public records`,
                    icon: Icons.lg.AdjustmentsHorizontalIcon
                },
                {
                    heading: `Get What You Paid For`,
                    content: `Be certain that your money goes to businesses you trust, and your purchases are authentic`,
                    icon: Icons.lg.BriefcaseIcon
                },
            ]
        },
