...
const truth = {
    ...
    hero: {
        ...
        subheading: `our Transparent Supply Chain Ecosystem secured with Blockchain`,
        link: {
            text: `Get Started`,
        ...
        'problem':{
            ...
            subsections: [
                ...
                },
                {
                    ...
                    content: `Chainleaf provides protection and security of consumer data and transactions to supporting a safe ecosystem`,
        ...
        'vision':{
            ...
            subsections: [
                ...
                },
                {
                    ...
                    content: `Rely on battle-tested abilities to remove human error, malicious edits and keep reports valid and up-to-date`,
                    icon: Icons.lg.CommandLineIcon,
                    tags: ['tech', 'growers'],
                },
                {
                    heading: `Increase Value`,
                    content: `Significantly increase return on investment by integrating smart analytics to optimize pricing, demand forecasting, and inventory management`,
